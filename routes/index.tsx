  ...
  return (
    <div  class=" w-full h-screen  bg-repeat bg-gradient-to-l from-purple-400 via-purple-300 to-indigo-300">
        <head>
          ...
          <meta property="twitter:title" content="Hellow World - Florian S."/>
      ...
      <h1 class="text-4xl text-center py-72 font-semibold inline-block">Hello World <img alt="waving hand" class="inline-block  h-12 w-12 " src="./wave.png"></img></h1>
      <p class="font-medium -my-72 px-2">I am Florian and i make stuff, below is some stuff i made</p>
      </div>
      <div class="flex flex-col items-center justify-center inline-block">
      <h2 class="font-semibold text-2xl text-center my-[20.5rem]">Projects</h2>
        <div class="relative  -my-80">
